...
-- pulse_out	=>  Location: PIN_J1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- button_in	=>  Location: PIN_G3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \pulse_out~reg0_q\ : std_logic;
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(0)) # ((count(29)) # ((count(30)) # (count(31))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (count(5)) # ((count(6)) # ((count(7)) # (count(8))))
...
-- Equation(s):
-- \count~0_combout\ = (\Add0~0_combout\ & \Equal0~10_combout\)
...
-- Equation(s):
-- \state~0_combout\ = (\state~q\ & ((\Equal0~10_combout\))) # (!\state~q\ & (\button_in~input_o\))
...
-- Equation(s):
-- \count[0]~1_combout\ = (\state~q\ & !\Reset~input_o\)
...
-- Equation(s):
-- \count~3_combout\ = (\Add0~4_combout\ & \Equal0~10_combout\)
...
-- Equation(s):
-- \Equal0~9_combout\ = ((count(3)) # ((count(1)) # (!count(2)))) # (!count(4))
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~8_combout\ & \Equal0~10_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (count(10)) # ((count(9)) # ((count(11)) # (count(12))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (count(15)) # (count(16))
...
-- Equation(s):
-- \Equal0~7_combout\ = (count(13)) # ((count(14)) # ((\Equal0~6_combout\) # (\Equal0~5_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (count(26)) # ((count(27)) # ((count(28)) # (count(25))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(19)) # ((count(20)) # ((count(18)) # (count(17))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(24)) # ((count(21)) # ((count(22)) # (count(23))))
...
\pulse_out~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \pulse_out~0_combout\ = (\state~q\ & ((\pulse_out~reg0_q\) # ((\button_in~input_o\ & !\Equal0~10_combout\))))
...
PORT MAP (
	dataa => \state~q\,
	datab => \button_in~input_o\,
	datac => \pulse_out~reg0_q\,
	datad => \Equal0~10_combout\,
	combout => \pulse_out~0_combout\);

-- Location: FF_X26_Y13_N25
\pulse_out~reg0\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
